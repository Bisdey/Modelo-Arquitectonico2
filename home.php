             ...
             <li class="list-group-item" id="requests">
                <div class="thumbnail">
                      ...
                      <center>
                        ...
                        <p><a href="logout.php"><i class="fa fa-power-off" aria-hidden="true"></i> Salir</a></p>
                        </center>
                      </div>
                    </div>
             </li>
                <!--
                <h4 style="text-decoration: none; color:black;">Lugar de estacionamiento</h4>
             <li class="list-group-item" >
               <select class="form-control" onchange="filter_park()" id="city">
                 <option value="Norte">Sector A</option>
                 <option value="Sur">Sector B</option>
                 <option value="Este">Sector C</option>
                 <option value="Oeste">Sector D</option>
               </select>
             </li>
           -->
             <h4 style="text-decoration: none; color:black;">Numero del Parking</h4>
             <li class="list-group-item">
               <select class="form-control" onchange="filter_park()" id="street">
                 <option value="">Nº 1</option>
                 <option value="">Nº 2</option>
                 <option value="">Nº 3</option>
                 <option value="">Nº 4</option>
                 <option value="Calle 5">Nº 5</option>
                 <option value="Calle 25">Nº 6</option>
                 <option value="Calle 1">Nº 7</option>
                 <option value="Calle 1">Nº 8</option>
                 <option value="Calle 1">Nº 9</option>
                 <option value="Calle 1">Nº 10</option>
               </select>
             </li>
