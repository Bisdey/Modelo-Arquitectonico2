  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="select<?=$parking_id; ?>">Guardar</button>
      </div>
    </div>
  </div>
</div>
...
<div class="panel panel-default parking_text">
  <div class="panel-body">
    <h4 class="Head">Sector A</h4>
    <hr>
    <ul class="list-group">
      <li class="list-group-item"><span class="glyphicon glyphicon-home"></span> Sitios de parqueo(<?=$parking_remaining;?>)</li>

    </ul>
    <button class="btn btn-default" type="button" data-backdrop="false" data-toggle="modal" data-target="#reserve<?=$parking_id ; ?>">Reservar</button>
...
<div class="modal fade parking_text" id="reserve<?=$parking_id ; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <ul class="list-group">
          <li class="list-group-item"><span class="glyphicon glyphicon-home"></span> Parqueo Unifranz</li>

          <li class="list-group-item"><span class="glyphicon glyphicon-tag"></span> <?=$parking_remaining; ?> espacios vacios</li>

          <li class="list-group-item"><span class="glyphicon glyphicon-credit-card"></span> 24 Horas, Por persona/li>
